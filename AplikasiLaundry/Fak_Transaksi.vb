...
Public Class Fak_Transaksi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AplikasiLaundry.Fak_Transaksi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFak_Transaksi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Fak_Transaksi = New Fak_Transaksi
        rpt.Site = Me.Site
        Return rpt
    End Function
