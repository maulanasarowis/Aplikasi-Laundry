...
Public Class Lap_Transaksi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AplikasiLaundry.Lap_Transaksi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLap_Transaksi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Lap_Transaksi = New Lap_Transaksi
        rpt.Site = Me.Site
        Return rpt
    End Function
